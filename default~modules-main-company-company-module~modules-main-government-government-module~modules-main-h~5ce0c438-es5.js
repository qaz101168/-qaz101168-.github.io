(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~modules-main-company-company-module~modules-main-government-government-module~modules-main-h~5ce0c438"],{
...
/***/ "./src/app/base/component.base.ts":
/*!****************************************!*\
  !*** ./src/app/base/component.base.ts ***!
  \****************************************/
...
/* harmony import */ var _services_provider_provider_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../services/provider/provider.service */ "./src/app/services/provider/provider.service.ts");
...
var ComponentBase = /** @class */ (function () {
    function ComponentBase(injector) {
        ...
        this.isError = false;
        this.errorMessage = '';
        this.providerSvc = injector.get(_services_provider_provider_service__WEBPACK_IMPORTED_MODULE_1__["ProviderService"]);
    }
    ComponentBase.prototype.resetConfirmState = function () {
        this.isConfirmed = false;
    };
    ComponentBase.prototype.resetErrorState = function () {
        this.isError = false;
        this.errorMessage = '';
    };
    ComponentBase.prototype.transactionConfirmed = function () {
        this.isPending = false;
        this.isConfirmed = true;
    };
    ComponentBase.prototype.transactionError = function (err) {
        this.isPending = false;
        this.isError = true;
        if (err) {
    ...
    ComponentBase.prototype.addressValidator = function (control) {
        var address = control.value;
        return _utils__WEBPACK_IMPORTED_MODULE_2__["Web3Utils"].isAddress(address) ? null : { message: "invalid address: " + address };
    };
    ComponentBase.prototype.setFormDisabled = function (formGroup, disable) {
        if (disable === void 0) { disable = true; }
        Object.keys(formGroup.controls).forEach(function (elem) {
            if (disable) {
    ...
    ComponentBase.ctorParameters = function () { return [
...
/*!********************************!*\
  !*** ./src/app/utils/index.ts ***!
  \********************************/
/*! exports provided: BN, Web3Utils */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _web3_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./web3-utils */ "./src/app/utils/web3-utils.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "BN", function() { return _web3_utils__WEBPACK_IMPORTED_MODULE_0__["BN"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Web3Utils", function() { return _web3_utils__WEBPACK_IMPORTED_MODULE_0__["Web3Utils"]; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Web3Utils", function() { return Web3Utils; });
...
/* harmony import */ var web3_eth_abi__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! web3-eth-abi */ "./node_modules/web3-eth-abi/src/index.js");
...
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../types */ "./src/app/types/index.ts");




var BN = web3_utils__WEBPACK_IMPORTED_MODULE_1__["BN"];
var Web3Utils = /** @class */ (function () {
    function Web3Utils() {
    }
    Web3Utils.randomHex = function (bytesSize) {
        return web3_utils__WEBPACK_IMPORTED_MODULE_1__["randomHex"](bytesSize);
    };
    Web3Utils.sha3 = function (message) {
        return web3_utils__WEBPACK_IMPORTED_MODULE_1__["sha3"](message);
    };
    Web3Utils.isBN = function (bn) {
        return web3_utils__WEBPACK_IMPORTED_MODULE_1__["isBN"](bn);
    };
    Web3Utils.isHex = function (message) {
        return web3_utils__WEBPACK_IMPORTED_MODULE_1__["isHex"](message);
    };
    Web3Utils.isHexStrict = function (message) {
        return web3_utils__WEBPACK_IMPORTED_MODULE_1__["isHexStrict"](message);
    };
    Web3Utils.isAddress = function (address) {
        return web3_utils__WEBPACK_IMPORTED_MODULE_1__["isAddress"](address);
    };
    Web3Utils.toHex = function (message) {
        return web3_utils__WEBPACK_IMPORTED_MODULE_1__["toHex"](message);
    };
    Web3Utils.toBN = function (num) {
        return web3_utils__WEBPACK_IMPORTED_MODULE_1__["toBN"](num);
    };
    Web3Utils.hexToUtf8 = function (hex) {
        return web3_utils__WEBPACK_IMPORTED_MODULE_1__["hexToUtf8"](hex);
    };
    Web3Utils.hexToAscii = function (hex) {
        return web3_utils__WEBPACK_IMPORTED_MODULE_1__["hexToAscii"](hex);
    };
    Web3Utils.utf8ToHex = function (message) {
        return web3_utils__WEBPACK_IMPORTED_MODULE_1__["utf8ToHex"](message);
    };
    Web3Utils.asciiToHex = function (message) {
        return web3_utils__WEBPACK_IMPORTED_MODULE_1__["asciiToHex"](message);
    };
    Web3Utils.hexToBytes = function (hex) {
        return web3_utils__WEBPACK_IMPORTED_MODULE_1__["hexToBytes"](hex);
    };
    Web3Utils.bytesToHex = function (bytesArray) {
        return web3_utils__WEBPACK_IMPORTED_MODULE_1__["bytesToHex"](bytesArray);
    };
    Web3Utils.toWei = function (value, uint) {
        return _types__WEBPACK_IMPORTED_MODULE_3__["EtherUnit"][uint] ? web3_utils__WEBPACK_IMPORTED_MODULE_1__["toWei"](value, _types__WEBPACK_IMPORTED_MODULE_3__["EtherUnit"][uint]) : web3_utils__WEBPACK_IMPORTED_MODULE_1__["toWei"](value, 'ether');
    };
    Web3Utils.decodeLog = function (eventName, receipt) {
        var abi = _types__WEBPACK_IMPORTED_MODULE_3__["ResumeContract"].abi.find(function (item) { return item.name === eventName && item.type === 'event'; });
        if (!abi) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["throwError"])("Not found event: " + eventName);
        }
        var inputs = abi.inputs;
        var logs = receipt.logs;
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["of"])(web3_eth_abi__WEBPACK_IMPORTED_MODULE_2__["decodeLog"](inputs, logs[0].data, logs[0].topics));
    };
    return Web3Utils;
}());
...
//# sourceMappingURL=default~modules-main-company-company-module~modules-main-government-government-module~modules-main-h~5ce0c438-es5.js.map