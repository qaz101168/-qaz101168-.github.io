...
class ComponentBase {
    ...
    setFormDisabled(formGroup, disable = true) {
...
const BN = web3_utils__WEBPACK_IMPORTED_MODULE_1__["BN"];
class Web3Utils {
    static randomHex(bytesSize) {
    ...
    static decodeLog(eventName, receipt) {
        const abi = _types__WEBPACK_IMPORTED_MODULE_3__["ResumeContract"].abi.find(item => item.name === eventName && item.type === 'event');
        if (!abi) {
...
//# sourceMappingURL=default~modules-main-company-company-module~modules-main-government-government-module~modules-main-h~5ce0c438-es2015.js.map