...
var SchoolCourseAddComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](SchoolCourseAddComponent, _super);
    function SchoolCourseAddComponent(injector, formBuilder) {
        var _this = _super.call(this, injector) || this;
        _this.injector = injector;
        _this.formBuilder = formBuilder;
        _this.courseForm = _this.formBuilder.group({
    ...
    SchoolCourseAddComponent.prototype.addCourse = function (data) {
        var _this = this;
        this.isPending = true;
        ...
        this.providerSvc.executeMethod(resume.methods.setCourse(data.name, data.content, data.comment, data.grade)
            .send({ from: this.providerSvc.defaultAccount })).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["take"])(1)).subscribe(function (receipt) {
            _this.transactionConfirmed();
            _this.courseForm.reset();
            _this.setFormDisabled(_this.courseForm, false);
        }, function (err) {
    ...
    SchoolCourseAddComponent.ctorParameters = function () { return [
    ...
    return SchoolCourseAddComponent;
...
var SchoolEducationAddComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](SchoolEducationAddComponent, _super);
    function SchoolEducationAddComponent(injector, formBuilder) {
        var _this = _super.call(this, injector) || this;
        _this.injector = injector;
        _this.formBuilder = formBuilder;
        _this.educationForm = _this.formBuilder.group({
            contract: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _this.addressValidator]],
    ...
    SchoolEducationAddComponent.prototype.addEducation = function (data) {
        var _this = this;
        this.isPending = true;
        ...
        this.providerSvc.executeMethod(resume.methods.setEducation(data.status, data.major)
            ...
            _this.setFormDisabled(_this.educationForm, false);
        }, function (err) {
    ...
    SchoolEducationAddComponent.ctorParameters = function () { return [
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }
    ]; };
    ...
    return SchoolEducationAddComponent;
...
var SchoolLicenseAddComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](SchoolLicenseAddComponent, _super);
    function SchoolLicenseAddComponent(injector, formBuilder) {
        var _this = _super.call(this, injector) || this;
        _this.injector = injector;
        _this.formBuilder = formBuilder;
        _this.licenseForm = _this.formBuilder.group({
            contract: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _this.addressValidator]],
            name: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
            content: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]]
        });
    ...
    SchoolLicenseAddComponent.prototype.addLicense = function (data) {
        var _this = this;
        var resume = this.providerSvc.getResume(data.contract);
        this.providerSvc.executeMethod(resume.methods.setLicense(data.name, data.content)
            .send({ from: this.providerSvc.defaultAccount })).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1)).subscribe(function (receipt) {
            _this.transactionConfirmed();
            _this.licenseForm.reset();
            _this.setFormDisabled(_this.licenseForm, false);
        }, function (err) {
            _this.transactionError();
            _this.licenseForm.reset();
            _this.setFormDisabled(_this.licenseForm, false);
    ...
    SchoolLicenseAddComponent.ctorParameters = function () { return [
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }
    ]; };
    ...
    return SchoolLicenseAddComponent;
}(src_app_base_component_base__WEBPACK_IMPORTED_MODULE_4__["ComponentBase"]));
...
//# sourceMappingURL=modules-main-school-school-module-es5.js.map